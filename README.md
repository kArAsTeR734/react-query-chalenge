...
### Результаты
Разработал простое NextJS приложения с подключенным внутри TanstackQuery для отправки и кэширования запросов. Получилось поглубже понять структуру TanstackQuery и поработать с его DevTools.
